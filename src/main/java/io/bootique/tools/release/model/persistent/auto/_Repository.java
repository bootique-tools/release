...
public abstract class _Repository extends GitHubEntity {
    ...
    public static final BaseProperty<GitStatus> LOCAL_STATUS = PropertyFactory.createBase("localStatus", GitStatus.class);
    ...
    protected GitStatus localStatus;
    ...
    public void setLocalStatus(GitStatus localStatus) {
        beforePropertyWrite("localStatus", this.localStatus, localStatus);
        this.localStatus = localStatus;
    }

    public GitStatus getLocalStatus() {
    ...
    public void writePropertyDirectly(String propName, Object val) {
        ...
        switch (propName) {
            case "description":
                ...
                break;
            case "localStatus":
                this.localStatus = (GitStatus)val;
                break;
            case "name":
    ...
    protected void readState(ObjectInputStream in) throws IOException, ClassNotFoundException {
        ...
        this.localStatus = (GitStatus)in.readObject();
