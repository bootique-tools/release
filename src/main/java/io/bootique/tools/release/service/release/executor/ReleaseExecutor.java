...
public class ReleaseExecutor implements ReleaseExecutorService {
    ...
    @Inject
    private StageManagerService stageManager;
    ...
    public void executeRelease() {
        if (releaseCanRunning() && isReleaseNotRunning() && releaseNotFinish()) {
    ...
    private boolean releaseNotFinish() {
    ...
    private boolean releaseCanRunning() {
    ...
    private boolean isReleaseNotRunning() {
